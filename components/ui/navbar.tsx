...
export const Navbar = () => {
    ...
    <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[min(1200px,calc(100%-2rem))]">
      <nav className="glass backdrop-blur-sm rounded-2xl px-4 sm:px-6 py-3 flex items-center justify-between">
        <a href="#" className="flex items-center gap-2 group">
          <div className="relative">
            <div className="w-9 h-9 rounded-xl bg-[#25707D] flex items-center justify-center shadow-glow">
              <Mic className="w-5 h-5 text-[#E5F7FA]" />
            </div>
          </div>
          <span className="font-bold text-lg tracking-tight text-foreground">
            Name-Voicer <span className="text-primary">AI</span>
          </span>
        </a>
        ...
        <div className="flex items-center gap-2">
          <Button size="sm" className="bg-[#25707D] text-white hover:opacity-90 shadow-glow gap-1.5">
